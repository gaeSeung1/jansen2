...
def detect_markers(img):
    ...
    distance1 = dist(curve[0][0][0],curve[0][0][1],curve[2][0][0],curve[2][0][1])
    distance2 = dist(curve[1][0][0],curve[1][0][1],curve[3][0][0],curve[3][0][1])
    distance = int((distance1 + distance2)/2)

    return markers_list, distance
